                ...
                <div class="flex flex-wrap justify-between gap-1 items-center">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-2">
                            <span class="text-gray-500 font-medium">Selecciona un mes:</span>
                                        ...
                                        @for ($i = 0; $i < 6; $i++)
                                            <tr>
                                                @for ($j = 0; $j < 7; $j++)
                                                    ...
                                                    @endphp
                                                    <td class="border text-center {{ $dayNumber < 1 || $dayNumber > $totalDays ? 'text-gray-400' : '' }}">
                                                        @if ($dayNumber >= 1 && $dayNumber <= $totalDays)
                                                            <button wire:click="setDay({{ $dayNumber }})" class="text-blue-500 hover:underline">{{ $dayNumber }}</button>
                                                        @endif
                                                    </td>
                                                @endfor
                                            </tr>
                        ...
                        <div class="flex items-center gap-2 mt-4">
                            @if ($day)
                                ...
                                <x-button sm primary label="Crear Asistencia" icon="plus" wire:click="createAttendance" />
                            @endif
                        </div>
                    </div>
                </div>
                                ...
                                <div class="relative flex p-2 gap-4 text-xs">
                                    ...
                                    <div class="col-span-3">
                                        ...
                                        <div class="absolute col-span-3 text-center top-2 right-2">
                                            ...
                                            @endphp
                                            <button wire:click="toggleAttendanceStatus({{ $member->id }})"
