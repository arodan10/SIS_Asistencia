                    ...
                    <div class="mb-2 md:w-[300px] w-full text-gray-500">
                        <x-native-select class="text-xs">
                            @foreach ($leaders as $leader)
                                <option value="{{ $leader->id }}">{{ $leader->firstname }} {{ $leader->lastname }}
                                    - {{ $leader->position }}</option>
                            @endforeach
                        </x-native-select>
                    </div>
                @endif
        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
            @foreach ($members as $member)
                <div class="w-full relative">
                    <div
                        class="bg-blue-50 rounded-md shadow-lg h-40 motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div class="text-center font-bold text-indigo-800">{{ $member->firstname }},
                            {{ $member->lastname }}</div>
                        <div class="flex p-2 gap-4 text-xs">
                            <div class="col-span-2">
                                <div><i class="text-indigo-400 fa-solid fa-mobile-screen-button text-xl h-6"></i>
                                </div>
                                <div><i
                            ...
                            <div class="col-span-3">
                                ...
                                <div>
                                    ...
                                    @endphp
                                    <ol class="flex">
                                        <li wire:click="store_study({{ $member }},1)"
                                            class="{{ $color1 }} w-6 h-6 text-center font-bold pt-1 text-gray-800 hover:scale-125 hover:bg-indigo-400 cursor-pointer">
                                            1</li>
                                        <li wire:click="store_study({{ $member }},2)"
                                            class="{{ $color2 }} w-6 h-6 text-center font-bold pt-1 text-gray-700 hover:scale-125 hover:bg-indigo-400 cursor-pointer">
                                            2</li>
                                        <li wire:click="store_study({{ $member }},3)"
                                            class="{{ $color3 }} w-6 h-6 text-center font-bold pt-1 text-gray-600 hover:scale-125 hover:bg-indigo-400 cursor-pointer">
                                            3</li>
                                        <li wire:click="store_study({{ $member }},4)"
                                            class="{{ $color4 }} w-6 h-6 text-center font-bold pt-1 text-gray-500 hover:scale-125 hover:bg-indigo-400 cursor-pointer">
                                            4</li>
                                        <li wire:click="store_study({{ $member }},5)"
                                            class="{{ $color5 }} w-6 h-6 text-center font-bold pt-1 text-gray-300 hover:scale-125 hover:bg-indigo-400 cursor-pointer">
                                            5</li>
                                        <li wire:click="store_study({{ $member }},6)"
                                            class="{{ $color6 }} w-6 h-6 text-center font-bold pt-1 text-gray-200 hover:scale-125 hover:bg-indigo-400 cursor-pointer">
                                            6</li>
                                        <li wire:click="store_study({{ $member }},7)"
                                            class="{{ $color7 }} w-6 h-6 text-center font-bold pt-1 text-gray-100 hover:scale-125 hover:bg-indigo-400 cursor-pointer">
                                            7</li>
                                    </ol>
                                </div>
                            </div>
