<x-guest-layout>
    ...
    <div>
        <div class="min-h-screen flex flex-col items-center justify-center bg-violet-950 p-4">
            <div
                class="bg-white grid md:grid-cols-2 items-center gap-4 max-w-5xl max-md:max-w-lg w-full p-4 m-4 shadow-lg rounded-xl">
                ...
                <div class="md:h-full bg-violet-950 rounded-xl lg:p-12 p-8 relative">
